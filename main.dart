...
class _JankenPageState extends State<JankenPage> {
 ...
 void damageCreater() {
    ...
    if (myHand == '✊' && result == '勝ち') {
      ...
      enemyDamage = -Random().nextInt(1000) + turn * turn * turn ; //
    } else {
      enemyDamage = 0;
    }
  }
      ...
      body: Column(
          ...
          Row(
            ...
            Align(
              ...
              child: CircleAvatar(
                backgroundImage:
                NetworkImage('https://4.bp.blogspot.com/-hRBXkRo9eCQ/U1jDTRZC63I/AAAAAAAAfjQ/01o8rxL07vM/s800/koinobori_kigurumi.png'),
               ),
      ...
      Center(
          ...
          children: [
            ...
            Align(
              ...
              child: CircleAvatar(
                backgroundImage:
                NetworkImage('https://4.bp.blogspot.com/-4KG-yR1RBHo/UgsvErk97eI/AAAAAAAAXPE/ZsGPpUAIQUA/s800/gutspose_man.png'),
              ),
            ),
